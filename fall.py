...
def draw():
    ...
    if gam0==True:
        screen.fill("black")
        screen.draw.text("You Lose!,Your level:"+str(level),(300,350),fontsize=35,color="red")
    elif gamW==True:
        screen.fill("black")
        screen.draw.text("You Win!,You completed all levels!",(300,350),fontsize=35,color="green")
    else:
